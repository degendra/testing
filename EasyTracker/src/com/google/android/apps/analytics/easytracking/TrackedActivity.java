...
public class TrackedActivity extends Activity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
      ...
      EasyTracker.getTracker().setContext(this);
    	  ...
    	  Log.v("EasyTracker", "Exception thrown in oncreate");
    	  e.printStackTrace();
      }
  }
  ...
  protected void onStart() {
    ...
    EasyTracker.getTracker().trackActivityStart(this);
	  ...
	  Log.v("EasyTracker", "Exception thrown in onstart");
	  e.printStackTrace();
  }
  }
  ...
  public Object onRetainNonConfigurationInstance() {
    ...
    EasyTracker.getTracker().trackActivityRetainNonConfigurationInstance();
  	  ...
  	  Log.v("EasyTracker", "Exception thrown in onretainConfigurationChange");
  	  e.printStackTrace();
    }
    return o;
  }
  ...
  protected void onStop() {
    ...
    EasyTracker.getTracker().trackActivityStop(this);
  	  ...
  	  Log.v("EasyTracker", "Exception thrown in onstop");
  	  e.printStackTrace();
    }
  }
}